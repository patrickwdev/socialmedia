...
import { View, Text, StyleSheet, TextInput, ScrollView, Image, TouchableOpacity, Dimensions, Platform, StatusBar } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  profileIconContainer: {
    ...
    height: 36,
    borderRadius: 18,
    backgroundColor: Colors.primary, // Orange in ref, keeping Blue for brand consistency
  ...
  notificationDot: {
    ...
    height: 8,
    borderRadius: 4,
    backgroundColor: Colors.text, // White dot as per ref
  },
  searchContainer: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  categoryPillActive: {
    backgroundColor: Colors.primary, // Keeping brand blue
  ...
  seeAllText: {
    color: Colors.primary, // Orange in ref
    fontSize: 14,
    fontWeight: '600',
  },
  suggestedContainer: {
